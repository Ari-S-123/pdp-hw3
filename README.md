...
- Generate counterexamples that show the opposite/broken principles for the examples of good functional programming principles present in @FP%20Usage.md.
- Can you update @README.md and @FP%20Usage.md to reflect all the changes we've made to the codebase together today?
- Can you generate a documentation html file based on the @README.md and also the @FP Usage.md file?
